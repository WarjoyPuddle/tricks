...
def verify_installation_contents_static(preset, cmake_source_dir) -> bool:
    ...
    expected_files = [
        "cmake/tricks-config.cmake",
        "cmake/tricks-config-debug.cmake",
        "cmake/tricks-config-relwithdebinfo.cmake",
        "cmake/tricks-config-release.cmake",
        "cmake/tricks-config-version.cmake",
        "include/tricks/tricks.hpp",
        "lib/Debug/libtricks_impl.a",
        "lib/RelWithDebInfo/libtricks_impl.a",
        "lib/Release/libtricks_impl.a",
    ]
...
def verify_installation_contents_shared(preset, cmake_source_dir) -> bool:
    ...
    expected_files = [
        ...
        "cmake/tricks-config-version.cmake",
        "include/tricks/tricks.hpp",
        "lib/Debug/libtricks_impl.so",
        "lib/RelWithDebInfo/libtricks_impl.so",
        "lib/Release/libtricks_impl.so",
    ]
