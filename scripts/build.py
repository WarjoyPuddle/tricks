...
MAIN_HEADER_PATH = f"{PROJECT_ROOT_DIR}/src/tricks/include/tricks/tricks.hpp"
assert os.path.isfile(MAIN_HEADER_PATH), "tricks.hpp does not exist"
...
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxClang,TEST_INSTALL_FIND_PACKAGE_NO_VERSION_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_FIND_PACKAGE_NO_VERSION_GCC_DIR = os.path.realpath(
#     f"{TEST_INSTALL_FIND_PACKAGE_NO_VERSION_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxGcc,TEST_INSTALL_FIND_PACKAGE_NO_VERSION_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_FIND_PACKAGE_NO_VERSION_CLANG_SHARED_DIR = os.path.realpath(
#     f"{TEST_INSTALL_FIND_PACKAGE_NO_VERSION_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxClangShared,TEST_INSTALL_FIND_PACKAGE_NO_VERSION_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_FIND_PACKAGE_NO_VERSION_GCC_SHARED_DIR = os.path.realpath(
#     f"{TEST_INSTALL_FIND_PACKAGE_NO_VERSION_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxGccShared,TEST_INSTALL_FIND_PACKAGE_NO_VERSION_CMAKE_SOURCE_DIR)}"
# )
#
...
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxClang,TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_GCC_DIR = os.path.realpath(
#     f"{TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxGcc,TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_CLANG_SHARED_DIR = os.path.realpath(
#     f"{TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxClangShared,TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_GCC_SHARED_DIR = os.path.realpath(
#     f"{TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_INSTALL_DIR",CMakePresets.LinuxGccShared,TEST_INSTALL_FIND_PACKAGE_EXACT_VERSION_CMAKE_SOURCE_DIR)}"
# )
#
...
# )
#
# TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_SOURCES_DIR = os.path.realpath(
#     f"{TEST_INSTALL_ADD_SUBDIRECTORY_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_SOURCES_PATH","base_sources_path",TEST_INSTALL_ADD_SUBDIRECTORY_CMAKE_SOURCE_DIR)}"
# )
#
# TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_CLANG_BUILD_DIR = os.path.realpath(
#     f"{TEST_INSTALL_ADD_SUBDIRECTORY_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_BUILD_PATH",CMakePresets.LinuxClang,TEST_INSTALL_ADD_SUBDIRECTORY_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_GCC_BUILD_DIR = os.path.realpath(
#     f"{TEST_INSTALL_ADD_SUBDIRECTORY_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_BUILD_PATH",CMakePresets.LinuxGcc,TEST_INSTALL_ADD_SUBDIRECTORY_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_CLANG_BUILD_SHARED_DIR = os.path.realpath(
#     f"{TEST_INSTALL_ADD_SUBDIRECTORY_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_BUILD_PATH",CMakePresets.LinuxClangShared,TEST_INSTALL_ADD_SUBDIRECTORY_CMAKE_SOURCE_DIR)}"
# )
# TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_GCC_BUILD_SHARED_DIR = os.path.realpath(
#     f"{TEST_INSTALL_ADD_SUBDIRECTORY_DIR}/"
#     f"{cache_var_from_preset("PRESET_TRICKS_BUILD_PATH",CMakePresets.LinuxGccShared,TEST_INSTALL_ADD_SUBDIRECTORY_CMAKE_SOURCE_DIR)}"
# )
#
...
# )
# EXAMPLE_QUICK_START_BUILD_AND_INSTALL_TRICKS_INSTALL_DIR = os.path.realpath(
#     f"{EXAMPLE_QUICK_START_BUILD_AND_INSTALL_CMAKE_SOURCE_DIR}/tricks_install___"
# )
#
...
# )
# EXAMPLE_QUICK_START_ADD_SUBDIRECTORY_TRICKS_SOURCE_DIR = os.path.realpath(
#     f"{EXAMPLE_QUICK_START_ADD_SUBDIRECTORY_THIRD_PARTY_DIR}/tricks"
# )
#
...
# )
# EXAMPLE_QUICK_START_CUSTOM_MAIN_TRICKS_INSTALL_DIR = os.path.realpath(
#     f"{EXAMPLE_QUICK_START_CUSTOM_MAIN_CMAKE_SOURCE_DIR}/tricks_install___"
# )
...
def clean_fn() -> bool:
    ...
    # )
    # remove_dir(TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_SOURCES_DIR)
    # remove_dir(TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_CLANG_BUILD_DIR)
    # remove_dir(TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_CLANG_BUILD_SHARED_DIR)
    # remove_dir(TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_GCC_BUILD_DIR)
    # remove_dir(TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_GCC_BUILD_SHARED_DIR)
    #
    # clean_build_dir(
    #     CMakePresets.Example, EXAMPLE_QUICK_START_BUILD_AND_INSTALL_CMAKE_SOURCE_DIR
    # )
    # remove_dir(EXAMPLE_QUICK_START_BUILD_AND_INSTALL_TRICKS_INSTALL_DIR)
    #
    # clean_build_dir(
    #     CMakePresets.Example, EXAMPLE_QUICK_START_ADD_SUBDIRECTORY_CMAKE_SOURCE_DIR
    # )
    ...
    #     CMakePresets.Example, EXAMPLE_QUICK_START_CUSTOM_MAIN_CMAKE_SOURCE_DIR
    # )
    # remove_dir(EXAMPLE_QUICK_START_CUSTOM_MAIN_TRICKS_INSTALL_DIR)
...
#         INFRASTRUCTURE_DIR,
#         f"{TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_SOURCES_DIR}/infrastructure",
#     )
#     recursively_copy_dir(
#         f"{PROJECT_ROOT_DIR}/src",
#         f"{TEST_INSTALL_ADD_SUBDIRECTORY_TRICKS_SOURCES_DIR}/src",
#     )
#
#     return True
#
...
#         CMakePresets.Example,
#         CMAKE_SOURCE_DIR,
#         EXAMPLE_QUICK_START_BUILD_AND_INSTALL_TRICKS_INSTALL_DIR,
#     )
#
...
#         CMakePresets.Example,
#         CMAKE_SOURCE_DIR,
#         EXAMPLE_QUICK_START_CUSTOM_MAIN_TRICKS_INSTALL_DIR,
#     )
#
#     success = configure_cmake(CMakePresets.Example, example_cmake_source_dir)
#     if not success:
...
#         f"{EXAMPLE_QUICK_START_ADD_SUBDIRECTORY_TRICKS_SOURCE_DIR}/infrastructure",
#     )
#     recursively_copy_dir(
#         f"{PROJECT_ROOT_DIR}/src",
#         f"{EXAMPLE_QUICK_START_ADD_SUBDIRECTORY_TRICKS_SOURCE_DIR}/src",
#     )
#
